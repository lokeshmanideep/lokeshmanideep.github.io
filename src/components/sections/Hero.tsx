...
export const Hero: React.FC = () =>
{
    ...
    return (
        <section className="min-h-screen flex items-center justify-center px-6 lg:px-8 bg-white">
            <div className="max-w-4xl w-full py-20">
                <div className="space-y-10">
                    ...
                    <div>
                        ...
                        <p className="text-2xl lg:text-3xl text-gray-700 font-semibold mb-3">
                            {personal.title}
                        </p>
                    ...
                    {/* Bio */}
                    <div className="space-y-5 text-lg text-gray-600 max-w-3xl leading-relaxed">
